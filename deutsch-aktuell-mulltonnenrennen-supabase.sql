...
-- Adapted to current Supabase schema
-- ============================================================

-- Assumptions based on the current tables:
-- texts(id, title, text_content, level, topic, access_status, published_at, created_at, slug)
...
-- 3. Insert vocabulary
-- This table is global in your schema and is not linked to a text_id.
-- To avoid duplicates on re-run, this uses a NOT EXISTS filter per entry.
